...
"[project]/Documents/personal-website/node_modules/framer-motion/dist/cjs/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var React = __turbopack_context__.r("[project]/Documents/personal-website/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
var popmotion = __turbopack_context__.r("[project]/Documents/personal-website/node_modules/popmotion/dist/popmotion.cjs.js [app-client] (ecmascript)");
...
var dom = __turbopack_context__.r("[project]/Documents/personal-website/node_modules/@motionone/dom/dist/index.es.js [app-client] (ecmascript)");
 ...
 */ try {
     ...
     */ loadExternalIsValidProp(__turbopack_context__.r("[project]/Documents/personal-website/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js [app-client] (ecmascript)").default);
} catch (_a) {
...
var makeUseVisualState = function(config) {
    return function(props, isStatic) {
        ...
        var presenceContext = React.useContext(PresenceContext);
        return isStatic ? makeState(config, props, context, presenceContext) : useConstant({
...
function useForceUpdate() {
    ...
    var forceRender = React.useCallback({
     ...
     * synchronous calls.
     */ var deferredForceRender = React.useCallback({
...
var LayoutGroup = function(_a) {
    ...
    var memoizedContext = React.useMemo({
        "LayoutGroup.useMemo[memoizedContext]": function() {
...
var AnimateSharedLayout = function(_a) {
    ...
    React__namespace.useEffect({
        "AnimateSharedLayout.useEffect": function() {
    ...
    return React__namespace.createElement(LayoutGroup, {
        id: useConstant({
            "AnimateSharedLayout.useConstant": function() {
 ...
 */ function MotionConfig(_a) {
     ...
     */ config.isStatic = useConstant({
        "MotionConfig.useConstant": function() {
     ...
     */ var context = React.useMemo({
        "MotionConfig.useMemo[context]": function() {
            return config;
        }
 ...
 */ function LazyMotion(_a) {
    ...
    React.useEffect({
        "LazyMotion.useEffect": function() {
            if (isLazyBundle(features)) {
                features().then({
                    "LazyMotion.useEffect": function(_a) {
...
function ReorderGroup(_a, externalRef) {
    ...
    var Component = useConstant({
        "ReorderGroup.useConstant[Component]": function() {
            return motion(as);
        }
    }["ReorderGroup.useConstant[Component]"]);
    var order = [];
    ...
    React.useEffect({
        "ReorderGroup.useEffect": function() {
            isReordering.current = false;
        }
    }["ReorderGroup.useEffect"]);
...
function useOnChange(value, callback) {
    useIsomorphicLayoutEffect({
        "useOnChange.useIsomorphicLayoutEffect": function() {
            if (isMotionValue(value)) return value.onChange(callback);
        }
    }["useOnChange.useIsomorphicLayoutEffect"], [
        callback
    ]);
}
function useMultiOnChange(values, handler) {
    useIsomorphicLayoutEffect({
        "useMultiOnChange.useIsomorphicLayoutEffect": function() {
            var subscriptions = values.map({
                "useMultiOnChange.useIsomorphicLayoutEffect.subscriptions": function(value) {
                    return value.onChange(handler);
                }
            }["useMultiOnChange.useIsomorphicLayoutEffect.subscriptions"]);
            return ({
                "useMultiOnChange.useIsomorphicLayoutEffect": function() {
                    return subscriptions.forEach({
                        "useMultiOnChange.useIsomorphicLayoutEffect": function(unsubscribe) {
                            return unsubscribe();
                        }
                    }["useMultiOnChange.useIsomorphicLayoutEffect"]);
                }
            })["useMultiOnChange.useIsomorphicLayoutEffect"];
        }
    }["useMultiOnChange.useIsomorphicLayoutEffect"]);
...
function useCombineMotionValues(values, combineValues) {
     ...
     */ useMultiOnChange(values, {
        "useCombineMotionValues.useMultiOnChange": function() {
            return sync__default["default"].update(updateValue, false, true);
        }
    }["useCombineMotionValues.useMultiOnChange"]);
    return value;
}
function useTransform(input, inputRangeOrTransformer, outputRange, options) {
    ...
    return Array.isArray(input) ? useListTransform(input, transformer) : useListTransform([
        ...
        "useTransform.useListTransform": function(_a) {
...
function ReorderItem(_a, externalRef) {
    ...
    var Component = useConstant({
        "ReorderItem.useConstant[Component]": function() {
            return motion(as);
        }
    }["ReorderItem.useConstant[Component]"]);
    ...
    var zIndex = useTransform([
        ...
        "ReorderItem.useTransform[zIndex]": function(_a) {
            var _b = tslib.__read(_a, 2), latestX = _b[0], latestY = _b[1];
            return latestX || latestY ? 1 : "unset";
        }
    }["ReorderItem.useTransform[zIndex]"]);
    ...
    React.useEffect({
        "ReorderItem.useEffect": function() {
            registerItem(value, measuredLayout.current);
        }
    }["ReorderItem.useEffect"], [
        context
    ]);
 ...
 */ function useSpring(source, config) {
    ...
    React.useMemo({
        "useSpring.useMemo": function() {
            return value.attach({
                "useSpring.useMemo": function(v, set) {
                    /**
    ...
    useOnChange(source, {
        "useSpring.useOnChange": function(v) {
            return value.set(parseFloat(v));
        }
    }["useSpring.useOnChange"]);
    return value;
}
/**
 ...
 */ function useVelocity(value) {
    ...
    React.useEffect({
        "useVelocity.useEffect": function() {
            return value.velocityUpdateSubscribers.add({
                "useVelocity.useEffect": function(newVelocity) {
                    velocity.set(newVelocity);
                }
            }["useVelocity.useEffect"]);
        }
    }["useVelocity.useEffect"], [
        value
    ]);
...
function useScroll(_a) {
    ...
    useIsomorphicLayoutEffect({
        "useScroll.useIsomorphicLayoutEffect": function() {
            return dom.scroll({
                "useScroll.useIsomorphicLayoutEffect": function(_a) {
                    var x = _a.x, y = _a.y;
            ...
            }["useScroll.useIsomorphicLayoutEffect"], tslib.__assign(tslib.__assign({}, options), {
...
function useAnimationFrame(callback) {
    ...
    var isStatic = React.useContext(MotionConfigContext).isStatic;
    React.useEffect({
        "useAnimationFrame.useEffect": function() {
            if (isStatic) return;
            var provideTimeSinceStart = {
                "useAnimationFrame.useEffect.provideTimeSinceStart": function(_a) {
                    var timestamp = _a.timestamp;
...
function useTime() {
    ...
    useAnimationFrame({
        "useTime.useAnimationFrame": function(t) {
            return time.set(t);
        }
 ...
 */ function useCycle() {
    ...
    var runCycle = React.useCallback({
        "useCycle.useCallback[runCycle]": function(next) {
            index.current = typeof next !== "number" ? popmotion.wrap(0, items.length, index.current + 1) : next;
            setItem(items[index.current]);
        }
    }["useCycle.useCallback[runCycle]"], tslib.__spreadArray([
        items.length
...
function useInView(ref, _a) {
    ...
    React.useEffect({
        "useInView.useEffect": function() {
            ...
            var onEnter = {
                "useInView.useEffect.onEnter": function() {
                    setInView(true);
...
function useInstantTransition() {
    ...
    React.useEffect({
        "useInstantTransition.useEffect": function() {
            /**
         * Unblock after two animation frames, otherwise this will unblock too soon.
         */ sync__default["default"].postRender({
                "useInstantTransition.useEffect": function() {
                    return sync__default["default"].postRender({
                        "useInstantTransition.useEffect": function() {
...
function useResetProjection() {
    var reset = React__namespace.useCallback({
        "useResetProjection.useCallback[reset]": function() {
 ...
 */ function useAnimatedState(initialState) {
    ...
    var element = useConstant({
        "useAnimatedState.useConstant[element]": function() {
    ...
    React.useEffect({
        "useAnimatedState.useEffect": function() {
            element.mount({});
            return element.unmount;
        }
    }["useAnimatedState.useEffect"], [
        element
    ]);
    React.useEffect({
        "useAnimatedState.useEffect": function() {
            element.setProps({
                onUpdate: {
                    "useAnimatedState.useEffect": function(v) {
    ...
    var startAnimation = useConstant({
        "useAnimatedState.useConstant[startAnimation]": function() {
            return ({
                "useAnimatedState.useConstant[startAnimation]": function(animationDefinition) {
...
//# sourceMappingURL=426f5_framer-motion_dist_cjs_index_3b5f00de.js.map